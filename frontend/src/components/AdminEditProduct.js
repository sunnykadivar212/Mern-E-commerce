        ...
        >
          ...
          <div>
            {data?.productImage[0] ? (
                ...
                {data.productImage.map((el, index) => {
                  return (
                    <div className="relative group">
                      ...
                      />
                      <div
                        className="absolute bottom-0 right-0 p-1 bg-red-500 text-white cursor-pointer rounded-full hidden group-hover:block"
                        onClick={() => {
              ...
              <p className="text-red-600 text-sm">*please upload image</p>
            )}
          </div>
          ...
          <button className="bg-red-500 px-3 py-1 mb-10 text-white hover:bg-red-600">
            Update Product
          </button>
        </form>
      </div>
