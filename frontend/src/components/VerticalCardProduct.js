        ...
        {loading ? (
         loadingList?.map((product, index) => {
              ...
              <div className="bg-white w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] rounded-sm shadow">
                ...
                <div className="p-4 grid gap-3">
                  ...
                  <div className="flex gap-3">
                    <p className="text-red-500 font-medium w-full p-1 py-2 animate-pulse rounded-full bg-slate-200">
                      
                    </p>
                    <p className="text-slate-500 line-through w-full p-1 py-2 animate-pulse rounded-full bg-slate-200">
                      
                    </p>
                  </div>
                  <button className="px-3 py-2 rounded-full text-white text-sm w-full animate-pulse bg-slate-200">
          ...
          data?.map((product, index) => {
            return (
              <Link to={"product/" + product._id} className="bg-white w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] rounded-sm shadow">
