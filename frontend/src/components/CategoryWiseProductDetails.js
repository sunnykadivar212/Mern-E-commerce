...
const CategoryWiseProductDetails = ({ category, heading }) => {
          ...
          : data?.map((product, index) => {
              return (
                <Link
                  ...
                  className="bg-white w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] rounded-sm shadow"
                  onClick={scrollTop}
                >
                  ...
                  <div className="p-4 grid gap-3">
                    ...
                    <button
                      className="bg-red-500 hover:bg-red-700 px-3 py-1 rounded-full text-white text-sm"
...
export default CategoryWiseProductDetails;
